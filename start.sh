...
sed -i "s^__CATALOG_ID__^$CATALOG_ID^g" /open311/config.json
sed -i "s^__OPERATOR_API_HOST__^$OPERATOR_API_HOST^g" /open311/config.json
sed -i "s^__OPERATOR_API_PORT__^$OPERATOR_API_PORT^g" /open311/config.json
